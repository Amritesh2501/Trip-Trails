    ...
    <div className="w-full h-full flex flex-col items-center justify-center p-4 animate-slide-up">
      <div className="mb-8 text-center relative">
         ...
         <h1 className="text-4xl md:text-7xl font-black font-display uppercase tracking-tighter leading-none mb-2 text-neo-black dark:text-neo-white">
            WANDER<span className="text-neo-blue">.OS</span>
         </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full">
        ...
        <button 
          ...
          className="group relative bg-neo-white dark:bg-neo-darkgray border-4 border-neo-black dark:border-neo-white p-6 md:p-8 h-64 flex flex-col justify-between hover:-translate-y-2 hover:shadow-neo-lg dark:hover:shadow-neo-lg-white transition-all text-left overflow-hidden"
        >
